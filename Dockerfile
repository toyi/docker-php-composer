...
RUN apk add --no-cache unzip zlib-dev icu-dev libpng-dev openssl-dev g++ gettext-dev libxml2-dev libzip-dev openssh-client
...
RUN apk del unzip zlib-dev icu-dev libpng-dev openssl-dev g++ gettext-dev libxml2-dev libzip-dev
